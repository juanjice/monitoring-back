package com.juanjice.springboot.controller;
...
import com.juanjice.springboot.exception.ResourceNotFoundException;
...
public class UserController {
	...
	@PutMapping("/users/{id}")
	public ResponseEntity<User> updateUser(@PathVariable Long id,@RequestBody User uuser){
		User user= userRepository.findById(id).
				orElseThrow(()-> new ResourceNotFoundException("employee not existe with id:"+id));
